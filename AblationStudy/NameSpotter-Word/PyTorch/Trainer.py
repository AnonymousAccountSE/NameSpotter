...
class Trainer(object):
    def __init__(self, params):
        ...
        self.out_features_dim = [self.label_num, self.hidden_size,  self.hidden_size, self.hidden_size]
        in_fea_final = self.out_features_dim[1] + self.out_features_dim[2]
        self.in_features_dim = [0, self.nums_node[1], self.nums_node[2], in_fea_final]
